...
erDiagram
    ...
    ARTICLE {
        ...
        bool is_profit "NOT NULL, default=true, Cloudflare WorkerがAdSense注入可否を判定"
        ...
        uuid_array option "NOT NULL, default=[], uuid[] OPTION.id配列"
    ...
    MEDIA_ASSET {
        ...
        string original_file_path "NOT NULL, max_length=500"
