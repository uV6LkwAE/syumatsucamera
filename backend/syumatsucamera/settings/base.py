...
CMS_ARTICLE_IMAGE_UPLOAD_MAX_BYTES = 60 * 1024 * 1024
CMS_ARTICLE_IMAGE_UPLOAD_REQUEST_MAX_BYTES = 64 * 1024 * 1024
...
# Django は multipart の合計サイズで先に弾くので、実ファイル上限より少し大きくする。
DATA_UPLOAD_MAX_MEMORY_SIZE = CMS_ARTICLE_IMAGE_UPLOAD_REQUEST_MAX_BYTES
